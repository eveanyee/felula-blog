...
Route::get('user/posts/upload', 'PostController@upload')->name('user.posts.upload');
Route::post('user/posts/upload', 'PostController@storeupload')->name('user.posts.storeupload');
